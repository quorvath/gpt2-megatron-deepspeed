...
class Float16OptimizerWithFloat16Params(MegatronOptimizer):
    ...
    def __init__(self, optimizer, clip_grad, log_num_zeros_in_grad,
        ...
        print_rank_0("self.float16_groups:",self.float16_groups)
        print_rank_0("self.fp32_from_float16_groups:",self.fp32_from_float16_groups)
        print_rank_0("self.fp32_from_fp32_groups:",self.fp32_from_fp32_groups)
